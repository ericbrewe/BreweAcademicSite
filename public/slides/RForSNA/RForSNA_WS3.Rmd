...
###  Now it is your turn, choose one of the ones that are easy to calculate and make the calculation. 

--
```{r}

with_graph(gr, graph_reciprocity()) #Reciprocity
with_graph(gr, graph_modularity())
...
## Create a function to calculate these all at once

## Consider how to compare to other networks
